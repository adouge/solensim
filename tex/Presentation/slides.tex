...
\begin{figure}
\subfloat[Solenoid with S, as optical axis\footfullcite{_Basic course on accelerator optics_ , Rossbach and P. Schmüser}]{\includegraphics[width = 0.5\textwidth]{Solenoid_scheme3.png}} 
\subfloat[Cross section through a magnetic lens\footfullcite{_Physical Principles of Electron Microscopy_ , Egerton, R.F.}]{\includegraphics[width = 0.5\textwidth]{Solenoid_pic1.png}}
\label{some example}
\end{figure}
  \end{frame}
...
\begin{figure}
  ...
  \caption{Solenoid cross-section along optic axis\footfullcite{_Physical Principles of Electron Microscopy_ , Egerton, R.F.}}
\end{figure}
  \begin{scriptsize}
\begin{columns}
...
-\frac{r'}{r}=\frac{1}{f}\underset{integrate\,(12)}{\Rightarrow}\frac{1}{f}=\left(\frac{e}{2p_{z}}\right)^{2}\intop_{-\infty}^{\infty}B_{z}^{2}dz\coloneqq\left(\frac{e}{2p_{z}}\right)^{2}F_{2}
  ...
  \begin{figure}
  \subfloat[Solenoid with a single layer of windings\footfullcite{_Design of Permanent MagneticSolenoids for REGAE_ , Gehrke T.}]{\includegraphics[width = 0.3\textwidth]     {Single_lay_solenoid2.png}} 
  \subfloat[Solenoid with multilayred windings\footfullcite{_Design of Permanent MagneticSolenoids for REGAE_ , Gehrke T.}]{\includegraphics[width = 0.3\textwidth]{Multilay_solenoid2.png}}
...
r_{c}\approx\alpha f\left(\triangle E_{0}/E_{0}\right)\approx\alpha C_{c}\left(\triangle E_{0}/E_{0}\right)
  ...
  \begin{tiny}
    \caption{Def. of the beam radius change due to spherical aberration\footfullcite{_Physical Principles of Electron Microscopy_ , Egerton, R.F.}}
  \end{tiny}
  \end{figure}
  \begin{tiny}
\begin{columns}
